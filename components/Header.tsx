...
const applyLocation = () => {
  ...
  // 🔥 NEW: If user types "all", clear location filter (show all listings)
...
{isLoggedIn && (
<>
<Link href="/account" className="text-[#D4AF37] hover:text-[#E5C158] transition-transform duration-200 hover:scale-110">
  <svg
